...
export const salesContent: LocalizedContent<PrototypeContent['sales']> = {
  ...
  ru: {
    ...
    outcomes: [
      'Поймёшь, почему мотоцикл может наклоняться намного сильнее, чем ты думаешь',
      'Уберёшь страх перед входом в поворот',
      'Получишь поэтапные упражнения для уверенности',
      'Поймёшь, как должен ощущаться эффективный и контролируемый наклон'
    ],
