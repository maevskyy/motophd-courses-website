...
**todo:** пусто — задачи ведутся в Linear (команда motophd), см. `docs/LINEAR.md`.
...
- [task_real_auth_14](./done/task_real_auth_14.md) — настоящий вход/выход через Payload, httpOnly-кука (коммит b608472)
- [task_protect_private_routes_15](./done/task_protect_private_routes_15.md) — замок на кабинет и плеер: логин + оплаченная покупка (b608472)
- [task_close_lesson_leak_16](./done/task_close_lesson_leak_16.md) — field-level доступ к содержимому уроков, `isFreePreview` работает (b608472)
- [task_media_stream_5](./done/task_media_stream_5.md) — медиа: R2 + Cloudflare Stream, PDF-роут (MOT-2)
- [task_payments_skeleton_6](./done/task_payments_skeleton_6.md) — платёжный каркас: `PaymentProvider`, серверный прайсинг, промокоды, mock-флоу, WayForPay (MOT-3, MOT-11)
